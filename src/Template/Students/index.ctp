...
if ($('input[name=data_selection]:checked').val() != null) {
   ...
   if(radioanswer == 1)
   {
    ...
    $('#sampleoutput').hide();
    $('#output').show();
    $("#output").html("<span style='font-size:18px;padding-left: 280px;'>Please upload only .txt or .csv file.</span>");
  ...
  <div style="background-color:#ACC2E9; height:540px;width:30%;float:left;">
    ...
    height: 440px;">
     ...
     <div id="custom_data" style="display:none;">
            ...
            <form action="ajaxUploadStudentsDetails" method="post" enctype="multipart/form-data" id="MyUploadForm">
            <input name="FileInput" id="FileInput" type="file" accept="text/plain,.csv"/>
